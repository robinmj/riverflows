...
public class Variable implements Serializable {
	...
	public enum CommonVariable {
		...
		WATERTEMP_F("Water Temperature", "°F"),
		INTERGRAVEL_WATERTEMP_C("Intergravel Water Temperature", "°C"),//Temperature, intragravel water, degrees Celsius 
		RES_STORAGE_ACRE_FT("Reservoir Storage", "acre-ft"),
		RES_ELEVATION_FT("Reservoir Surface Elevation", "ft"),//Elevation above NGVD 1929, ft
		TIDE_ELEVATION_FT("Tide elevation above NAVD 1988","ft"),
		AIRTEMP_F("Air Temperature", "°F"),
		AIRTEMP_C("Air Temperature", "°C"),//Temperature, air, &#176;C
		...
		SPECIFIC_CONDUCTANCE_MICROSIEMEN_AT_25C("Specific Conductance","µS/cm at 25°C"),
		DISSOLVED_O2_MG_L("Dissolved Oxygen","mg/L"),//Dissolved oxygen, water, unfiltered, mg/L
		DISSOLVED_O2_PCT("Dissolved Oxygen","%"),//Dissolved oxygen, water, unfiltered, %saturation
		...
		ATM_PRESSURE_MM_HG("Barometric Pressure", "mm Hg"),
		ATM_PRESSURE_MB("Barometric Pressure", "mb"),
		DCP_BATTERY_VOLTAGE("DCP Battery Voltage","V"),
		DCP_SIGNAL_MODULATION_INDEX_DB("DCP signal modulation index","dB"),
		ACOUSTIC_DOPPLER_VELOCITY_METER_SIGNAL_NOISE_RATIO("Acoustic Doppler Velocity Meter signal to noise ratio",""),
